...
function Home() {
  ...
  return (
    <div>
        ...
        <button className={style.btnmenumobile}><a href="#0"><box-icon name='home' type='solid' color='#ffffff' ></box-icon></a></button>
        <button className={style.btnmenumobile}><a href="#1"><box-icon name='info-circle' color='#ffffff' ></box-icon></a></button>
        <button className={style.btnmenumobile}><a href="#2"><box-icon name='spreadsheet' color='#ffffff' ></box-icon></a></button>
        <button className={style.btnmenumobile}><a href="#3"><box-icon name='graduation' type='solid' color='#ffffff' ></box-icon></a></button>
      </div>
      <div id="0" className={style.bloco1}>
      ...
      <div id="1" className={style.section2}>Home</div>
        <div className={style.divsobre}>
          <div className={style.divtxtsobre}>
            <div className={style.divttlsobre}><h2>Sobre</h2></div>
        ...
        <div className={style.containerhabilidades} style={{ height: Vermais ? "auto" : "auto", transition: "0.5s" }}>
          <div className={style.Habilidade}>
            <div className={style.divhabilidade}>
              <div className={style.ttldivhabilidade}> HTML</div>
              <div className={style.textdivhabilidade}>  É uma linguagem de marcação utilizada na construção de páginas na Web.</div>
            </div>
          ...
          <div className={Vermais ? style.HabilidadeCSS : style.HabilidadeCSS1}>
            <div className={style.divhabilidade}>
              <div className={style.ttldivhabilidade}> CSS</div>
              <div className={style.textdivhabilidade}>  É um mecanismo para adicionar estilo a um documento Web.</div>
            </div>
            <div className={style.imgHabilidade}>
          ...
          {Vermais && (
            <div>
              <div className={style.Habilidade}>
                <div className={style.divhabilidade}>
                  <div className={style.ttldivhabilidade}> Java script</div>
                  <div className={style.textdivhabilidade}>  É uma linguagem de programação juntamente com HTML e CSS, é uma das três
              ...
              <div className={style.Habilidade}>
                <div className={style.divhabilidade}>
                  <div className={style.ttldivhabilidade}> React JS</div>
                  <div className={style.textdivhabilidade}> O React é uma biblioteca JavaScript declarativa, eficiente e flexível para criar
              ...
              <div className={style.Habilidade}>
                <div className={style.divhabilidade}>
                  <div className={style.ttldivhabilidade}> Node JS</div>
                  <div className={style.textdivhabilidade}>  Node.js é um software de código aberto, multiplataforma, baseado no
              ...
              <div className={style.Habilidade}>
                <div className={style.divhabilidade}>
                  <div className={style.ttldivhabilidade}> My SQL</div>
                  <div className={style.textdivhabilidade}>  O MySQL é um sistema de gerenciamento de banco de dados, que utiliza a linguagem
