...
import Carossel from './components/Carossel/Carousel';

//imagens
import iconeGitHub from './img/icone-git-hub.png';
import iconeLinkedin from './img/linkedin-logo-48.png';
...
function App() {
  ...
  const [Section, setSection] = useState([1, 2, 3, 4]);
  ...
  return (
    <div>
      <div className={Menu ? styleApp.divmenumobile0 : styleApp.divmenumobile1}>
        <button className={styleApp.btnmenumobile}><a href="#1"><box-icon name='home' type='solid' color='#ffffff' ></box-icon></a></button>
        <button className={styleApp.btnmenumobile}><a href="#2"><box-icon name='info-circle' color='#ffffff' ></box-icon></a></button>
        <button className={styleApp.btnmenumobile}><a href="#3"><box-icon name='spreadsheet' color='#ffffff' ></box-icon></a></button>
        <button className={styleApp.btnmenumobile}><a href="#4"><box-icon name='graduation' type='solid' color='#ffffff' ></box-icon></a></button>
      </div>
      <div id={Section[0]} className={styleApp.bloco1}>
        <header style={{ width: "100%", height: "70px", position: "absolute" }}><NavBar setMenu={setMenu} menu={Menu} section={Section} /></header>
        <div className={styleApp.divtitulo}>
          <div className={styleApp.divtitulo1} >
            <div className={styleApp.ttlW}>Wender Fabiano</div>
            <div className={styleApp.ttlD}><span>Desenvolvedor Web&nbsp;</span><span className={styleApp.piscar}>|</span></div>
      ...
      <div id={Section[3]} className={styleApp.bloco4}>
        ...
        <div className={styleApp.containerhabilidades} style={{ height: Vermais ? "auto" : "auto", transition: "0.5s" }}>
          ...
          {Vermais && (
            <div>
              <div className={styleApp.Habilidade}>
                <div className={styleApp.divhabilidade}>
                  <div className={styleApp.ttldivhabilidade}> Java script</div>
                  <div className={styleApp.textdivhabilidade}>  É uma linguagem de programação juntamente com HTML e CSS, é uma das três
                    principais tecnologias da Web.</div>
                </div>
                <div className={styleApp.imgHabilidade}>
                  <img src={iconeJS} alt="" />
                </div>
              ...
              <div className={styleApp.Habilidade}>
                <div className={styleApp.divhabilidade}>
                  <div className={styleApp.ttldivhabilidade}> React JS</div>
                  <div className={styleApp.textdivhabilidade}> O React é uma biblioteca JavaScript declarativa, eficiente e flexível para criar
                    interfaces. Ele permite compor UIs complexas a partir de pequenos e isolados códigos chamados
                    “componentes”.</div>
                </div>
                <div className={styleApp.imgHabilidade}>
              ...
              <div className={styleApp.Habilidade}>
                <div className={styleApp.divhabilidade}>
                  <div className={styleApp.ttldivhabilidade}> Node JS</div>
                  <div className={styleApp.textdivhabilidade}>  Node.js é um software de código aberto, multiplataforma, baseado no
                    interpretador V8 do Google e que permite a execução de códigos JavaScript fora de um navegador web.</div>
                </div>
                <div className={styleApp.imgHabilidade}>
                  <img src={iconeNode} alt="" />
                </div>
              </div>
              <div className={styleApp.Habilidade}>
                <div className={styleApp.divhabilidade}>
                  <div className={styleApp.ttldivhabilidade}> My SQL</div>
                  <div className={styleApp.textdivhabilidade}>  O MySQL é um sistema de gerenciamento de banco de dados, que utiliza a linguagem
                    SQL como interface. É atualmente um dos sistemas de gerenciamento de bancos de dados mais populares da
                    Oracle Corporation, com mais de 10 milhões de instalações pelo mundo.</div>
                </div>
                <div className={styleApp.imgHabilidade}>
                  <img src={iconeDB} alt="" />
                </div>
        ...
        <div className={styleApp.btnvermais}>
          <button className={styleApp.btnVerMenos} onClick={Fvermais}>{BtnVermais}</button>
        </div>
      </div>
      <footer className={styleApp.footer}>
        <span>Feito por: Wender Fabiano</span>
        <span>Email: wenderfabianoalves@gmail.com</span>
      </footer>
    </div>
  )
}
